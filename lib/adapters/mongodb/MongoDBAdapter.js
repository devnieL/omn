...
class MongoDBAdapter {
  static create(instance_class) {
    ...
    if (instance_class.db) {
      if (instance_class.db.type != "mongodb") throw new Error("To use a MongoDBAdapter, a MongoDB db connection should be set");
    }
  ...
  static createSchema(instance_class, collection) {
    ...
    var parsed_schema = {}; // Parse schema for MongoDB
