...
class Instance {
    ...
    toJSON(_propertiesAsObject){
        ...
        for(var i in current_properties){
            if(RESERVED_PROPERTIES.indexOf(current_properties[i]) == '-1'){
                ...
                if(InstanceUtils.isArrayProperty(current_properties[i])){
                    property.type = self.constructor.schema[i][0].name;
                }else{
                    property.type = self.constructor.schema[i].name;
                }
    ...
    static async populateProperties(instance){
        ...
        var properties_to_populate = InstanceUtils.getPropertiesToPopulate(instance.constructor.schema);
        ...
        for(let property of properties_to_populate){
            ...
            if(InstanceUtils.isArrayProperty(properties[property])){
                ...
                properties[property] = await Promise.all(properties[property].map(async function(id){
                    ...
                    var InstanceClass = instance.constructor.schema[property][0];
                    log.debug("model:", Model);

                    var _instance = await InstanceClass.read(id);
        ...
        switch(this.db.type){
            ...
            case "neo4j":
                ...
                try{
                    ...
                    log.debug({
                        instance : instance
                    }, "Instance.read() object to return");
    ...
    static buildQuery(query){
        ...
        let objectPropertiesWithClassNames = InstanceUtils.getObjectProperties(this.schema);
    ...
    static async find(query){
        ...
        try{
            ...
            log.debug({
                instances
            }, "Instance.find() objects to return");
    ...
    static async findOne(query){
        ...
        log.debug({ query, db_type : this.db.type }, "Instance.findOne()");
        ...
        switch(this.db.type){
            ...
            case "mongodb":
                ...
                try{
                    ...
                    log.debug({ query, result }, "Instance.findOne() result");
                    ...
                    log.debug({ instance }, "Instance.findOne() object to return");
            ...
            case "postgresql":
                ...
                try{
                    ...
                    log.debug({instance }, "Instance.find() object to return");
