...
describe('Neo4jAdapter', () => {
    ...
    it('should update an instance the Entity inherited class with Neo4j as a database', async () => {
        pending();
    });
    ...
    it('should run a raw query using the Entity inherited class', async () => {
        pending();
    });
